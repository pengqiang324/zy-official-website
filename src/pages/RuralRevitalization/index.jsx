...
function RuralRevitalization() {
    ...
    return (
        <div className='RuralRevitalization'>
            <div className="RuralRevitalization-banner"></div>
                            ...
                            shopList.map((shop, index) => (
                                <div className="RuralRevitalization-shop--item" key={index}>
                                    <OverPack key="0" always={false} playScale={0.1}>
                                        <TweenOne key="01" animation={{ scale: 0, type: 'from', ease: 'linear' }}>
                                    ...
                                    <OverPack key="2" always={false} playScale={0.1}>
                                        <TweenOne key="20" animation={{ scale: 0, type: 'from', ease: 'linear' }}>
